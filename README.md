These OSL scripts were written with Blender 2.8x . For that reason they do not use all features available in OSL. The [[ ]] syntax to provide explanatory comments for parameters in shader function signatures.
