These OSL scripts were written with Blender 2.8x. They do not use all features available in OSL, such as the [[ ]] syntax to provide explanatory comments for parameters in shader function signatures.
